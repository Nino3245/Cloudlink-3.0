...
var ipfetcherurl = "https://web.archive.org/web/20220424065114/https://api.ipify.org/";

// Get the server URL list
try {
	fetch('https://web.archive.org/web/20220424065114/https://mikedev101.github.io/cloudlink/serverlist.json').then(response => {
...
class cloudlink {
		...
		return {
			...
			blocks: [
			{
				...
				arguments: {
						url: {
							type: Scratch.ArgumentType.STRING,
							defaultValue: 'https://web.archive.org/web/20220424065114/https://mikedev101.github.io/cloudlink/fetch_test'
						}
					}
			},	{
				opcode: 'parseJSON',
	...
	changeIPFetcher(args) {
		if (args.url == "Default") {
			ipfetcherurl = "https://web.archive.org/web/20220424065114/https://api.ipify.org/";
		} else if (args.url == "Meower") {
			ipfetcherurl = "https://web.archive.org/web/20220424065114/https://api.meower.org/ip";
		};
...
/*
     FILE ARCHIVED ON 06:51:14 Apr 24, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:24:59 Nov 26, 2022.
...
/*
playback timings (ms):
  captures_list: 140.081
  exclusion.robots: 0.204
  exclusion.robots.policy: 0.184
  cdx.remote: 0.15
  esindex: 0.018
  LoadShardBlock: 106.826 (3)
  PetaboxLoader3.resolve: 124.109 (5)
  PetaboxLoader3.datanode: 68.578 (5)
  CDXLines.iter: 22.688 (3)
  load_resource: 121.008 (2)
*/
